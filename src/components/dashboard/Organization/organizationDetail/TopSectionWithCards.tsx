...
import AddInsuranceForm from './AddInsuranceForOrganization';
import InsuranceForm from '../../forms/insuranceModuleForm/insuranceForm';
  ...
  return (
    <div className="mb-4 flex flex-row gap-5 max-lg:flex-wrap">
      <div className="container flex flex-col items-start pt-[0.9375rem] pr-[0.9375rem] pb-[0.9375rem] pl-[0.9375rem] w-[21.25rem] rounded-[0.625rem] border border-[#d8dadc] bg-white">
        <div className="header flex flex-col items-start self-stretch">
          <div className="flex justify-between items-center self-stretch">
            <div className="organization_information text-[#1e4477] text-[16px] font-medium font-roboto text-base leading-6">
        ...
        <div className="content flex flex-col items-start self-stretch mt-4 font-roboto">
          {/* Billing Address */}
          <div className="address flex flex-col items-start">
            <div className="billing_address text-[#334155] font-medium text-xs leading-4">
              Billing Address
            </div>
            <div className="text-[#334155] text-xs font-normal leading-4 tracking-[0.4px] mt-1">
          ...
          <div className="contact flex flex-col items-start mt-4">
            <div className="contact-1 text-[#334155] font-medium text-xs leading-4">
              Contact
            </div>
          ...
          <div className="contact-2 flex flex-col items-start mt-4">
            <div className="start_date text-[#334155] font-medium text-xs leading-4">
              Start Date
            </div>
            <div className="text-[#334155] text-xs font-normal leading-4 tracking-[0.4px] mt-1">
              {companyDetails.start_date ?
                new Date(companyDetails.start_date).toLocaleString('en-US', {
                  month: 'long',
                  day: 'numeric',
                  year: 'numeric'
                }).replace(/(\d+)/, '$1') :
      ...
      {selectedInsuranceId && (
        ...
        // <InsuranceForm mode='edit' insuranceId={selectedInsuranceId} onClose={handleCloseEditForm}/>
      )}
      {showAddForm && (
        <AddInsuranceForm
          ...
          onSuccess={() => {
            ...
            console.log("Insurance plans updated successfully");
            // Optionally add a function to refresh the company details
          }}
        />
      )}
    </div>
